# Plan an academic week

Create a realistic plan for classes, assignments, study, and project work

Version 0.1

## Summary

Plan an academic week is slowed mainly by search the lms and email for deadlines, rewrite assignments into a task list, build the weekly calendar. The redesign adds repeatable structure while preserving human judgment.

| Step | Classification | Opportunity | Recommendation |
| --- | --- | --- | --- |
